...
export const metadata: Metadata = {
  ...
  description: 'Descubre ofertas de cumpleaños de las mejores marcas. Regalos, descuentos, sorteos y experiencias seleccionadas para tu día especial.',
  keywords: ['cumpleaños', 'ofertas', 'descuentos', 'regalos', 'beneficios', 'promociones', 'celebración'],
  ...
  twitter: {
    ...
    title: 'CumplePlan - Celebra con beneficios exclusivos',
    description: 'Descubre ofertas de cumpleaños de las mejores marcas. Regalos, descuentos, sorteos y experiencias.',
...
const jsonLd = {
  ...
  name: 'CumplePlan',
  url: siteUrl,
  description: 'Plataforma de ofertas y beneficios de cumpleaños de las mejores marcas.',
  publisher: {
    '@type': 'Organization',
    name: 'CumplePlan',
    logo: {
